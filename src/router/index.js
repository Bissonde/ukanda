...
const routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        // this generates a separate chunk (about.[hash].js) for this route
        // which is lazy-loaded when the route is visited.
        component: () => import(/* webpackChunkName: "home" */ '@/views/Campaigns.vue'),
      },
      {
        path: '/calendar',
        name: 'calendar',
      ...
      },
      {
        ...
        // this generates a separate chunk (about.[hash].js) for this route
        // which is lazy-loaded when the route is visited.
        component: () => import(/* webpackChunkName: "home" */ '@/views/Email.vue'),
      },
      {
        path: '/message',
        name: 'message',
      ...
      },
      {
        ...
        // this generates a separate chunk (about.[hash].js) for this route
        // which is lazy-loaded when the route is visited.
        component: () => import(/* webpackChunkName: "home" */ '@/views/WhatsApp.vue'),
      },
      {
        path: '/history',
        name: 'history',
